...
current_state = (0 for i in range(Nodes))
network = pyphi.Network(tpm, current_state)
...
# External elements
subsystem2 = pyphi.Subsystem((0, 2, 4, 5), network)

# Hidden elements, no External
hidden_indices = np.array([3, 4])
subsystem3 = pyphi.Subsystem(range(network.size), network,
                             hidden_indices=hidden_indices)

# Hidden and External elements
hidden_indices = np.array([1, 3])
subsystem4 = pyphi.Subsystem((0, 1, 3, 5), network,
                             hidden_indices=hidden_indices)

# Only macro
output_grouping = ((0, 1, 2), (3, 4, 5))
state_grouping = (((0, 1), (2, 3)), ((0,), (1, 2, 3)))
subsystem5 = pyphi.Subsystem(range(network.size), network,
                             output_grouping=output_grouping,
                             state_grouping=state_grouping)
# Macro and External
output_grouping = ((1, 3), (2, 5))
state_grouping = (((0, 1), (2,)), ((0,), (1, 2)))
subsystem6 = pyphi.Subsystem((1, 2, 3, 5), network,
                             output_grouping=output_grouping,
                             state_grouping=state_grouping)
...
hidden_indices = (3, 4)
subsystem7 = pyphi.Subsystem(range(network.size), network,
                             hidden_indices=hidden_indices,
                             output_grouping=output_grouping,
                             state_grouping=state_grouping)
...
subsystem8 = pyphi.Subsystem((1, 2, 3, 4, 5), network,
                             hidden_indices=hidden_indices,
                             output_grouping=output_grouping,
                             state_grouping=state_grouping)
